...
INSERT INTO products (name, slug, base_price, category_id, description, specifications, default_image, is_active, created_at, updated_at) VALUES
...
INSERT INTO product_variant_options (variant_id, option_key, option_value, color_code, price_modifier, images, is_default, is_available, display_order)
SELECT 
...
INSERT INTO product_variant_options (variant_id, option_key, option_value, price_modifier, is_default, is_available, display_order)
SELECT 
    ...
    'storage-256', '256 ГБ', 0, true, true, 1
ON CONFLICT DO NOTHING;

INSERT INTO product_variant_options (variant_id, option_key, option_value, price_modifier, is_default, is_available, display_order)
SELECT 
    (SELECT id FROM product_variants WHERE product_id = (SELECT id FROM products WHERE slug = 'iphone-15-pro-max') AND variant_key = 'storage'),
    'storage-512', '512 ГБ', 20000, false, true, 2
ON CONFLICT DO NOTHING;

INSERT INTO product_variant_options (variant_id, option_key, option_value, price_modifier, is_default, is_available, display_order)
SELECT 
    (SELECT id FROM product_variants WHERE product_id = (SELECT id FROM products WHERE slug = 'iphone-15-pro-max') AND variant_key = 'storage'),
    'storage-1tb', '1 ТБ', 40000, false, true, 3
ON CONFLICT DO NOTHING;
...
-- Опции для Nike
INSERT INTO product_variant_options (variant_id, option_key, option_value, color_code, price_modifier, is_default, is_available, display_order)
SELECT 
    ...
    'color-black', 'Черный', '#000000', 0, true, true, 1
ON CONFLICT DO NOTHING;

INSERT INTO product_variant_options (variant_id, option_key, option_value, color_code, price_modifier, is_default, is_available, display_order)
SELECT 
    (SELECT id FROM product_variants WHERE product_id = (SELECT id FROM products WHERE slug = 'nike-air-max-270') AND variant_key = 'color'),
    'color-white', 'Белый', '#FFFFFF', 0, false, true, 2
ON CONFLICT DO NOTHING;
...
SELECT 
    ...
    'size-41', '41', 0, true, true, 1
ON CONFLICT DO NOTHING;

INSERT INTO product_variant_options (variant_id, option_key, option_value, price_modifier, is_default, is_available, display_order)
SELECT 
    (SELECT id FROM product_variants WHERE product_id = (SELECT id FROM products WHERE slug = 'nike-air-max-270') AND variant_key = 'size'),
    'size-42', '42', 0, false, true, 2
ON CONFLICT DO NOTHING;

INSERT INTO product_variant_options (variant_id, option_key, option_value, price_modifier, is_default, is_available, display_order)
SELECT 
    (SELECT id FROM product_variants WHERE product_id = (SELECT id FROM products WHERE slug = 'nike-air-max-270') AND variant_key = 'size'),
    'size-43', '43', 0, false, true, 3
ON CONFLICT DO NOTHING;
